...
class Generate_Constraints():
    ...
    def determine_constraint_atoms(self, single_pose_prody, current_conformer, current_residue_index, verbose=False):
        """
        ...
        # todo: should probably add an option for this instead of relying of len(split)...
        ...
        cluster = residue_split[3] if len(residue_split) == 7 else residue_split[1]
        ...
        for solution_tuples in sorted(list(cluster_list_set)):
            ...
            for solution_tuple in solution_tuples: # (fragment, cluster)
                ...
                for cluster_residue in residue_row_indices:
                    ...
                    constraint_atoms_dict = self.determine_constraint_atoms(single_pose_prody, conformer, residue_index, verbose=False)
    ...
    def conventional_constraints_from_gurobi_solutions(self, gurobi_solutions_csv_dir, constraints_to_generate=1000, iteration=False):
        ...
        :param gurobi_solutions_csv_dir: path to csv containing solutions generated by gurobi
        :param iteration: if iteration, then generate constraints for all solutions without consolidating scores. 
        Ignores `constraints_to_generate` parameter. 
        :return: 
        """
        # Set things up
