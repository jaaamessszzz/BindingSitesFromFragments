...
class score_with_gurobi():
    ...
    #     df = pd.read_csv('./{}/Motifs/Residue_Ligand_Interactions/Single_Poses/residue_index_mapping.csv'.format(self.user_defined_dir), index_col=0)
    ...
    def do_gurobi_things(self):
        ...
        for struct_id, table in residue_table.groupby(['struct_id']):
            ...
            # Set Parameters
            residue_interactions.Params.PoolSolutions = 100
            # residue_interactions.Params.SolutionNumber = 100
            residue_interactions.Params.PoolSearchMode = 1
