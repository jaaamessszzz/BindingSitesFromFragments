...
class Generate_Constraints():
    ...
    def BW_constraints_from_gurobi_solutions(self, gurobi_solutions_csv, use_solution_residues_only=True):
        """
        ...
        :return: 
        """
        # todo: set option to use only residues found in solutions, or all residues from clusters
        ...
        pprint.pprint(self.res_idx_map_df)

        # Set up dict for clusters using motif_clusters.yaml
        fragment_name_dict = self.assemble_cluster_dict(names_only=True)
        pprint.pprint(pd.DataFrame(fragment_name_dict))
